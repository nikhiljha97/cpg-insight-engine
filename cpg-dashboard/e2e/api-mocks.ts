    ...
    await route.fulfill({
      ...
      body: JSON.stringify({
        ...
        posts: [
          {
            id: "uat1",
            title: "Grocery prices feel expensive this week",
            subreddit: "canada",
            permalink: "https://www.reddit.com/r/canada/comments/uat1/",
            snippet: "UAT stub post about grocery prices.",
            matchedTemplates: ["uat"],
            relevanceScore: 8,
            sentiment: { score: -0.35, label: "Stress-heavy", lexical: -0.55, relevanceNorm: 0.36 },
          },
        ],
        topTerms: [{ term: "grocery", count: 2 }],
        search: {
        ...
        sentimentAnalysis: {
          ...
          index0to100: 32,
          label: "UAT net label",
          methodology: "UAT Reddit Canada retail pulse stub.",
          sampleSize: 1,
          buckets: { stressHeavy: 1, mixed: 0, reliefLeaning: 0 },
        },
